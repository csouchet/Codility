 ...
 * Finally, it meets fish number 4 and is eaten by it. The remaining two fish, number 0 and 4, never 
...
public class Fish {
	public int solution(int[] A, int[] B) {
		...
		return numberOfDownstream + queue.size();
	}
}
